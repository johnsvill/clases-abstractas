...
namespace ClasesAbstractas
{
    public class clsClientesConContacto : clsClientesBase
    {
        ...
        public clsClientesConContacto(int pId, string pNombre, string pClave, string pRFC, int pTipoRegimen,
            ...
            string pNumeroExterior, string pNumeroInterior, string pColonia, string pMunicipio, string pEstado, string pCP)
        {
            Id = pId;
            Nombre = pNombre;
            Clave = pClave;
            ...
            Email = pEmail;
            _Direccion = new clsDirecciones();
            Direccion.Calle = pCalle;//Se hace referencia al objeto y luego a la propiedad del objeto
